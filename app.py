...
def run_integration_test(output_dir: str = "./reports"):
    ...
    test_report = {
        "threats": {
            ...
            "malware": random.choice([True, False]),
            "ransomware": random.choice([True, False])
        },
    ...
    return test_report, performance_report


# Streamlit UI
st.set_page_config(page_title="DefenSys", page_icon="🛡️")
st.title("🛡️ DefenSys: AI Threat Detection System")

if st.button("Run System Test"):
    test_report, performance_report = run_integration_test()
